...
## 1. Send us your project id and number

```bash
gcloud projects describe <your-project> --format='value(projectId,projectNumber)'
```

Then **wait for the release tag**. We compile your project number into our consumer
images. The images must exist before you can pin them. If you apply before this, there
is no digest to pin.
